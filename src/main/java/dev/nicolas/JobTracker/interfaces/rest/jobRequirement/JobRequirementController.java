...
public class JobRequirementController {
    ...
    private final UpdateJobRequirementUseCase updateJobRequirementUseCase;
    ...
    public JobRequirementController(CreateJobRequirementUseCase createJobRequirementUseCase,
                                    ...
                                    UpdateJobRequirementUseCase updateJobRequirementUseCase) {
        ...
        this.updateJobRequirementUseCase = updateJobRequirementUseCase;
    }
    ...
    @PatchMapping("/job-requirements/{id}")
    public ResponseEntity<JobRequirementResponse> updateJobRequirement(@PathVariable UUID id,
                                                                       @Valid @RequestBody UpdateJobRequirementRequest request) {
        return ResponseEntity.ok(updateJobRequirementUseCase.execute(id, request));
    }
